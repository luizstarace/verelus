...
export default function AtalaiaLanding({ config }: { config: VerticalConfig }) {
  ...
  return (
    <div className="min-h-screen bg-brand-bg text-brand-text font-sans">
      ...
      {/* ── Para quem é o Atalaia ── */}
      <section className="bg-white py-20">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-4">Para quem é o Atalaia</h2>
          <p className="text-brand-muted text-center mb-14 max-w-xl mx-auto">
            Se você atende clientes e perde mensagens fora do horário, o Atalaia foi feito pra você.
          </p>
      ...
      <section className="bg-brand-bg py-20">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-4">Atendente humano vs Atalaia</h2>
          <p className="text-brand-muted text-center mb-14 max-w-xl mx-auto">
            ...
            <table className="w-full max-w-3xl mx-auto">
              <thead>
                <tr className="border-b-2 border-brand-border">
                  ...
                  <th className="px-5 py-4 text-sm font-semibold text-brand-trust w-1/3">Atalaia</th>
                </tr>
              </thead>
              <tbody>
                {[
