// Per-vertical landing-page config consumed by AttendlyLanding.
...
export type VerticalConfig = {
  slug: string;            // 'attendly' (main) | 'salao' | 'clinica' | 'restaurante' | 'academia'
  canonicalPath: string;   // '/attendly' or '/attendly/salao' etc.
...
export const mainConfig: VerticalConfig = {
  slug: 'attendly',
  canonicalPath: '/attendly',
  breadcrumbName: 'Attendly',
  heroH1: (
    <>
...
export const salaoConfig: VerticalConfig = {
  ...
  heroSubtitle:
    'Sua cliente quer marcar manicure às 22h? O Attendly responde no WhatsApp e no site do salão, agenda e confirma — sem você precisar olhar o celular.',
  faq: [
...
export const clinicaConfig: VerticalConfig = {
  slug: 'clinica',
  canonicalPath: '/attendly/clinica',
  ...
  heroSubtitle:
    'Pacientes marcam consulta a qualquer hora pelo WhatsApp. O Attendly responde com seus horários reais e libera sua recepcionista pra cuidar de quem está na clínica.',
  faq: [
    ...
    { q: 'O atendente sabe diferenciar dúvida clínica de agendamento?', a: 'Sim. Para qualquer pergunta sobre saúde, sintoma ou tratamento, o Attendly transfere automaticamente pra um profissional humano em vez de inventar resposta.' },
...
export const restauranteConfig: VerticalConfig = {
  slug: 'restaurante',
  canonicalPath: '/attendly/restaurante',
  ...
  faq: [
    ...
    { q: 'Funciona se eu uso iFood ou Rappi paralelamente?', a: 'Sim. O Attendly cuida do canal direto (WhatsApp + site). Os apps continuam normais. Cliente que vem direto evita a comissão dos apps.' },
...
export const academiaConfig: VerticalConfig = {
  slug: 'academia',
  canonicalPath: '/attendly/academia',
  ...
  heroSubtitle:
    'Aluno quer saber preço, horário de aula ou marcar avaliação física? O Attendly responde 24h pelo WhatsApp e site, e te conecta com o lead quando ele estiver pronto pra matricular.',
  faq: [
