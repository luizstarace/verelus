...
export default function OverviewDashboard() {
  ...
  // Stripe redirects back to /dashboard/atalaia?checkout=success after a paid
  ...
  if (!business) {
    return (
      <div className="p-8 text-center">
        ...
        <a href="/dashboard/atalaia/setup" className="inline-block bg-brand-cta text-white font-bold px-6 py-3 rounded-lg hover:brightness-110 transition-all">
    ...
    <div className="p-8 space-y-6">
      ...
      {stats && stats.usage_percentage >= 80 && (
        <div className="bg-brand-cta/10 border border-brand-cta/30 rounded-lg p-4 text-sm">
          ...
          <a href="/dashboard/atalaia/billing" className="underline font-bold text-brand-cta">Ver plano</a>
        </div>
      )}
