...
export default function ConversationDetail({ conversationId, onBack, onStatusChange }: Props) {
  ...
  const fetchConversation = useCallback(async () => {
    try {
      const res = await fetch(`/api/attendly/conversations/${conversationId}`);
  ...
  async function handleReply(e: React.FormEvent) {
    ...
    setSending(true);
    try {
      const res = await fetch(`/api/attendly/conversations/${conversationId}/reply`, {
        method: 'POST',
  ...
  async function updateStatus(newStatus: string) {
    ...
    try {
      const res = await fetch(`/api/attendly/conversations/${conversationId}/status`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
