    ...
    <div className="min-h-screen bg-brand-dark text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-invert prose-sm max-w-none text-zinc-300 space-y-6">
          ...
          <h2 className="text-xl font-semibold text-white mt-8">2. Descrição do Serviço</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8">4. Conteúdo Gerado por IA</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8">6. Uso Aceitável</h2>
          <p>Você concorda em não utilizar o Serviço para fins ilegais, spam, ou gerar conteúdo que viole direitos de terceiros.</p>

          <h2 className="text-xl font-semibold text-white mt-8">7. Limitação de Responsabilidade</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8">8. Alterações nos Termos</h2>
          ...
          <p>Para dúvidas sobre estes termos, entre em contato: <a href="mailto:contato@verelus.com" className="text-brand-green">contato@verelus.com</a></p>
        </div>
      </div>
    </div>
  );
