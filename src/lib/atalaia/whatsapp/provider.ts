...
export interface BusinessProviderContext {
  ...
  // Twilio: identifiers and active phone (E.164) when provider='twilio' and Sender approved
...
export function resolveProvider(business: BusinessSubset, now: Date = new Date()): BusinessProviderContext {
  ...
  return {
    ...
    twilio_sender_sid: business.twilio_sender_sid,
    twilio_phone: business.whatsapp_provider === 'twilio' ? business.whatsapp_number : null,
