...
const TEMPLATE: ChecklistItem[] = [
  // ===== D-56 (8 semanas antes) — FUNDAMENTOS =====
  {
    ...
    description: 'Envie pra um mastering engineer ou use um servico online tipo LANDR. Receba os arquivos em WAV 24bit 44.1kHz. Sem masterizacao decente, playlists editoriais nem consideram.',
    due_offset_days: -56,
    phase: 'D-56',
    category: 'production',
    importance: 'critical',
  ...
  },
  {
    ...
    description: 'Minimo 3000x3000px JPG/PNG. Cuide dos direitos da imagem — se usou foto de alguem, precisa ter autorizacao escrita. Capa e a primeira coisa que o fa ve; vale investir.',
    due_offset_days: -56,
    phase: 'D-56',
    category: 'production',
    importance: 'critical',
  ...
  },
  {
    ...
    description: 'Essencial pra receber direitos autorais de execucao publica. Sem esse registro voce perde dinheiro de radio, bares, shows. Gratuito.',
    due_offset_days: -56,
    phase: 'D-56',
    category: 'rights',
  ...
  // ===== D-28 (4 semanas antes) =====
  {
    ...
    description: 'Pra lancar na data X, submeter no minimo 21 dias antes (recomendado 4 semanas). Isso garante pitch pro Spotify editorial via Spotify for Artists e evita atrasos na data de release.',
    due_offset_days: -28,
    phase: 'D-28',
    category: 'distribution',
    importance: 'critical',
  ...
  },
  {
    ...
    description: 'Use o Spotify for Artists -> Pitching. Submeta pelo menos 21 dias antes do lancamento. Escreva pitch especifico sobre o que a musica tem de unico — use o Pitch Kit do Verelus pra gerar texto profissional.',
    due_offset_days: -28,
    phase: 'D-28',
    category: 'distribution',
  ...
  },
  {
    ...
    description: 'Pre-save antecipado conta como stream na primeira semana. Essencial pra chart e pra o algoritmo do Spotify identificar momentum. Sem pre-save voce desperdica 4 semanas de hype.',
    due_offset_days: -28,
    phase: 'D-28',
    category: 'marketing',
    importance: 'critical',
  ...
  },
  {
    ...
    description: 'Planeje 30 dias de posts coordenados antes do lancamento. Use o Cronograma de Posts do Verelus pra gerar ideias, captions e datas ja prontas.',
    due_offset_days: -28,
    phase: 'D-28',
    category: 'marketing',
  ...
  },
  {
    ...
    description: 'Identifique 10-20 veiculos/curadores relevantes pro seu genero. Anote email/forma de contato e tom especifico de cada um. Lista mal montada = pitches genericos ignorados.',
    due_offset_days: -28,
    phase: 'D-28',
    category: 'press',
    importance: 'important',
  ...
  // ===== D-14 (2 semanas antes) =====
  {
    ...
    description: 'Playlists editoriais e jornalistas precisam receber pitch no minimo 2 semanas antes da release. Use o Pitch Kit pra gerar email + 1-pager profissional. Envie com link de pre-save + preview privado da musica.',
    due_offset_days: -14,
    phase: 'D-14',
    category: 'press',
    importance: 'critical',
  ...
  },
  {
    ...
    description: 'Revelar o mood/clima da musica. Nao mostre o audio ainda — gere curiosidade. Story + reel. Veja o Cronograma de Posts pra ideias de caption e formato.',
    due_offset_days: -14,
    phase: 'D-14',
    category: 'marketing',
    importance: 'important',
  ...
  },
  {
    ...
    description: 'Sticker de countdown. Facil, gera lembrete automatico em quem se inscreve. Anuncie a data firme — a primeira semana depende desse hype concentrado.',
    due_offset_days: -7,
    phase: 'D-7',
    category: 'marketing',
    importance: 'important',
  ...
  },
  {
    ...
    description: 'Evento na data do release ou na semana. Pode ser show fisico, live no Instagram, ou listening party online. Cria ritual + conteudo. Se for show fisico, gere rider e contrato antes.',
    due_offset_days: -7,
    phase: 'D-7',
    category: 'live',
    importance: 'optional',
  ...
  },
  {
    ...
    description: 'Clica em cada link como se fosse um fa. Funciona pro Spotify? Pra Apple? Link do 1-pager abre? Resolve qualquer problema antes — link quebrado no dia do release desperdica todo o hype.',
    due_offset_days: -7,
    phase: 'D-7',
    category: 'distribution',
    importance: 'critical',
  ...
  // ===== D-0 (dia do lancamento) =====
  {
    ...
    description: 'Coordenado: Reel IG, video TikTok, tweet, story. Cada um adaptado pra plataforma. Sua bio deve estar atualizada em todo lugar antes disso — use a Bio Adaptativa pra ter as 4 versoes otimizadas prontas.',
    due_offset_days: 0,
    phase: 'D-0',
    category: 'marketing',
    importance: 'critical',
  ...
  },
  {
    ...
    description: 'Agradecer curadores com personal touch. Essa relacao vale pros proximos releases. Nao seja so transacional — use o Pitch Kit pra montar um follow-up com tom pessoal.',
    due_offset_days: 14,
    phase: 'D+14',
    category: 'press',
    importance: 'important',
