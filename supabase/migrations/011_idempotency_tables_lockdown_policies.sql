...
-- attendly_evolution_events_processed and stripe_events_processed are written
...
CREATE POLICY no_client_access ON public.attendly_evolution_events_processed
  FOR ALL TO public
